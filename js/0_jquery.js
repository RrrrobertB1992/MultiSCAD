! function(e, t) {
	...
	b.extend({
		...
		clone: function(e, t, n) {
			...
			if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || b.isXMLDoc(e)))
				for (a = pe(c), r = 0, i = (o = pe(e)).length; r < i; r++) s = o[r], u = a[r], void 0, l = u.nodeName.toLowerCase(), "input" === l && ue.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
			if (t)
				if (n)
	...
	function ut(e, t, n) {
		...
		for (function(e, t) {
				var n, r, i, o, a;
				for (n in e)
					if (r = U(n), i = t[r], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = b.cssHooks[r]) && "expand" in a) {
